PROJECT_NAME     := nrf52-secure-firmware
...
SRC_FILES += \
  ...
  $(SOURCE_ROOT)/le_secure.c \
  $(SOURCE_ROOT)/led_button.c \
  $(SOURCE_ROOT)/pm.c \
  $(SOURCE_ROOT)/ble_init.c \
  $(SOURCE_ROOT)/services.c \
  $(SOURCE_ROOT)/adv.c \
  $(SOURCE_ROOT)/conn.c \
  $(SOURCE_ROOT)/counter.c \
  $(APPS_ROOT)/main.c \
...
SDK_CONFIG_FILE := $(APPS_ROOT)/sdk_config.h
